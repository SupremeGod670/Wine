...
@Database(entities = {WineryEntity.class, WineEntity.class, AppUserEntity.class, RepresentativeEntity.class, ClientEntity.class, SaleEntity.class, SaleItemEntity.class, RegionEntity.class, WineStockEntity.class}, version = 11) // VERSÃO ATUALIZADA
